...
local tasklist_buttons = gears.table.join(
    ...
    awful.screen.connect_for_each_screen(function(s)
        ...
        globalkeys = gears.table.join(
            ...
            -- Function Controls
            awful.key({ }, "XF86AudioRaiseVolume", function () awful.spawn("volc up") end,
            {description = "Increase Volume", group = "Function Controls"}),
            awful.key({ }, "XF86AudioLowerVolume", function () awful.spawn("volc down") end,
            {description = "Decrease Volume", group = "Function Controls"}),
            awful.key({ }, "XF86AudioMute", function () awful.spawn("volc mute") end,
            {description = "Mute Volume", group = "Function Controls"}),
            awful.key({ }, "XF86MonBrightnessUp", function () awful.spawn("backlight up") end,
            {description = "Decrease Brightness", group = "Function Controls"}),
            awful.key({ }, "XF86MonBrightnessDown", function () awful.spawn("backlight down") end,
            {description = "Increace Brightness", group = "Function Controls"}),
            ...
            awful.key({ modkey,           }, "d", function () awful.spawn.with_shell(rofi) end,
